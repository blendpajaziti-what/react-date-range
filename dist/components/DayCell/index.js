...
var DayCell = /*#__PURE__*/function (_Component) {
  ...
  function DayCell(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderWeekNumber", function () {
      var _this$props6 = _this.props,
          day = _this$props6.day,
          isStartOfWeek = _this$props6.isStartOfWeek;

      if (isStartOfWeek) {
        var numberOfWeeks = (0, _dateFns.differenceInWeeks)(day, (0, _dateFns.startOfYear)(day)) + 1;
        return /*#__PURE__*/_react["default"].createElement("span", {
          className: "rdrWeekNumber"
        }, numberOfWeeks);
      }
    });
  ...
  _createClass(DayCell, [{
    ...
    value: function render() {
      ...
      }), this.renderSelectionPlaceholders(), this.renderPreviewPlaceholder(), this.renderWeekNumber(), /*#__PURE__*/_react["default"].createElement("span", {
